...
export const ShareCard = forwardRef<HTMLDivElement, Props>(function ShareCard(
  ...
  return (
    <div ref={ref} className={`share-card share-card--${background}`}>
      <span className="share-card__badge">PROJECT ON THE GRID</span>
      ...
      <div className="share-card__center">
        ...
        {project.description && <p className="share-card__description">{project.description}</p>}
      ...
      {showStats && (
        <div className="share-card__stats">
          <div>
            <div className="share-card__stat-label">Time left</div>
          ...
          <div>
            ...
            <div className="share-card__stat-value">{project.territory_size} cells</div>
          </div>
        </div>
      )}
    </div>
